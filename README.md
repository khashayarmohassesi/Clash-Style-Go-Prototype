...
## Authentication
No auth providers or JWT, Only guest logins. Client sends `X-Player-ID` header after guest login, Server validates player existence on each request
...
## Notes
This is a prototype. No migrations or ORM included. Upgrade completion is not yet processed by a background worker (future improvement)
